...
int __cdecl main(Platform::Array<Platform::String^>^ /*argv*/)
{
	...
	std::shared_ptr<ITurboGameRenderer> renderer = std::shared_ptr<ITurboGameRenderer>(new DirectX12TKRenderer(debug, ioService));
	...
	//std::shared_ptr<ITurboGame> game = std::shared_ptr<ITurboGame>(new MazeTest(debug));
	//std::shared_ptr<ITurboGame> game = std::shared_ptr<ITurboGame>(new TestGame(debug));

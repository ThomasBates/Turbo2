...
{
	ref class SpaceLabyrinthDX12NavigationControl 
	{
	internal:
		//  Constructors and Destructors  ------------------------------------------------------------------------------
		SpaceLabyrinthDX12NavigationControl();
		//virtual ~SpaceLabyrinthDX12NavigationControl();

		int	GetNavigationInfo(NavInfo *navInfo);

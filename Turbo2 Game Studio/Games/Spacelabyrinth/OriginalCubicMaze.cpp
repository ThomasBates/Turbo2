...
/*
OriginalCubicMaze::OriginalCubicMaze()
{
	_corners = 0;
	_edges   = 0;
	_walls   = 0;
...
/*
void OriginalCubicMaze::BuildWalls()
{
...
/*
int OriginalCubicMaze::BuildCorner(int w, int h, int d)
{
...
int OriginalCubicMaze::BuildWEdge(int w, int h, int d)
{
...
int OriginalCubicMaze::BuildHEdge(int w, int h, int d)
{
...
int OriginalCubicMaze::BuildDEdge(int w, int h, int d)
{
...
int OriginalCubicMaze::BuildRightWall(int w, int h, int d)
{
	int index = (w + (h + d*(_size.h+1))*(_size.w+1))*3 + 0;
...
int OriginalCubicMaze::BuildBottomWall(int w, int h, int d)
{
	int index = (w + (h + d*(_size.h+1))*(_size.w+1))*3 + 1;
	MazeObject *mazeObject = &(_walls[index]);
...
int OriginalCubicMaze::BuildFrontWall(int w, int h, int d)
{
	int index = (w + (h + d*(_size.h+1))*(_size.w+1))*3 + 2;
	MazeObject *mazeObject = &(_walls[index]);

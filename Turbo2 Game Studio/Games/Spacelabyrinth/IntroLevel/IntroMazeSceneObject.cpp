...
IntroMazeSceneObject::IntroMazeSceneObject(std::shared_ptr<ITurboSceneMesh> mesh, std::shared_ptr<ITurboSceneMaterial> material)
{
	Mesh(mesh);
	Material(material);
}
...
bool IntroMazeSceneObject::IsTouching(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
...
bool IntroMazeSceneObject::IsTouchingLeftSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool IntroMazeSceneObject::IsTouchingRightSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool IntroMazeSceneObject::IsTouchingTopSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool IntroMazeSceneObject::IsTouchingBottomSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool IntroMazeSceneObject::IsTouchingBackSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool IntroMazeSceneObject::IsTouchingFrontSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();

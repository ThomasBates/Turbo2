...
bool OriginalMazeSceneObject::IsTouching(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
...
bool OriginalMazeSceneObject::IsTouchingLeftSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool OriginalMazeSceneObject::IsTouchingRightSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool OriginalMazeSceneObject::IsTouchingTopSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool OriginalMazeSceneObject::IsTouchingBottomSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool OriginalMazeSceneObject::IsTouchingBackSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();
...
bool OriginalMazeSceneObject::IsTouchingFrontSideOfWall(TurboVector3D fromPoint, TurboVector3D toPoint, double buffer, TurboVector3D *pContact, TurboVector3D *pNormal)
{
	std::shared_ptr<ITurboSceneMesh> mesh = Mesh();

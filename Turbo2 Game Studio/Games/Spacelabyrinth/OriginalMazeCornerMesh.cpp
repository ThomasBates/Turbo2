...
OriginalMazeCornerMesh::OriginalMazeCornerMesh()
{
	...
	AddVertex(Vector3D(left__, bottom, back__), normal, Vector2D(1.0f, 0.0f));
	AddVertex(Vector3D(left__, top___, back__), normal, Vector2D(1.0f, 1.0f));
	AddVertex(Vector3D(right_, top___, back__), normal, Vector2D(0.0f, 1.0f));
	AddVertex(Vector3D(right_, bottom, back__), normal, Vector2D(0.0f, 0.0f));


	normal = Vector3D(0.0f, 1.0f, 0.0f);
	AddVertex(Vector3D(left__, bottom, front_), normal, Vector2D(0.0f, 1.0f));
	...
	AddVertex(Vector3D(right_, bottom, front_), normal, Vector2D(1.0f, 1.0f));
	...
	AddVertex(Vector3D(right_, top___, back__), normal, Vector2D(0.0f, 0.0f));
	AddVertex(Vector3D(left__, top___, back__), normal, Vector2D(1.0f, 0.0f));

...
{
    _sceneView = std::shared_ptr<ITurboView>(new TurboSceneView("Main Scene View", _rendererAccess, _viewModel->MainSceneViewModel()));
//    _hud1View = std::shared_ptr<ITurboView>(new MazePreviewHUD1View(viewModel->HUD1ViewModel()));
//    _hud2View = std::shared_ptr<ITurboView>(new MazePreviewHUD2View(viewModel->HUD2ViewModel()));

    _mainControlView = std::shared_ptr<ITurboView>(new MazePreviewMainControlView("Main Control View", _rendererAccess, _viewModel->MainControlViewModel()));
    _motionControlView = std::shared_ptr<ITurboView>(new MazePreviewMotionControlView("Motion Control View", _rendererAccess, _viewModel->MotionControlViewModel()));
    _directionControlView = std::shared_ptr<ITurboView>(new MazePreviewDirectionControlView("Direction Control View", _rendererAccess, _viewModel->DirectionControlViewModel()));

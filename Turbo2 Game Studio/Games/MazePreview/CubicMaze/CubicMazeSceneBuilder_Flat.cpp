...
CubicMazeSceneBuilder_Flat::CubicMazeSceneBuilder_Flat()
{
    _baseSceneBuilder = std::shared_ptr<ICubicMazeSceneBuilder>(new CubicMazeSceneBuilder(
            ColorMaterial(0.4, 0.4, 0.4),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryCorner")),
            ColorMaterial(0.4, 0.4, 0.4),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryEdge")),

            ColorMaterial(0.5, 0.5, 0.5),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryWall")),
            ColorMaterial(0.5, 0.5, 0.5),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryWall")),
            ColorMaterial(0.5, 0.5, 0.5),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryWall")),
            ColorMaterial(0.5, 0.5, 0.5),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryWall")),
            ColorMaterial(0.5, 0.6, 0.5),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryFloor")),
            ColorMaterial(0.5, 0.5, 0.6),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryCeiling")),

            ColorMaterial(0.2, 0.8, 0.2),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryEntrance")),
            ColorMaterial(0.8, 0.2, 0.2),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryLocked")),
            ColorMaterial(0.5, 0.5, 0.5),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryWall")),

            ColorMaterial(0.2, 0.2, 0.8),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryExit")),
            ColorMaterial(0.8, 0.2, 0.2),   //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryLocked")),
            ColorMaterial(0.5, 0.5, 0.5)    //  std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial("LaboratoryWall"))
    ));
}
...
//    ));
    ...
    std::shared_ptr<ITurboSceneMaterial> material = std::shared_ptr<ITurboSceneMaterial>(new TurboSceneMaterial(
            TurboColor(r, g, b),			//	Ambient
            TurboColor(r, g, b),			//	Diffuse
            TurboColor(0.3f, 0.3f, 0.3f),			//	Specular

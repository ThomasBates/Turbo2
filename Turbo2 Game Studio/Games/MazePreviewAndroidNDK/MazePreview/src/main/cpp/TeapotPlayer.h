...
//#include <TeapotTypes.h>

using namespace Turbo::Math;
using namespace Turbo::Scene;

class TeapotPlayer : public ITurboSceneObject
{
public:
    //TeapotPlayer(TeapotUserOptions* userOptions);
    TeapotPlayer();
    virtual ~TeapotPlayer(){}
...
//    TeapotUserOptions*								_userOptions;

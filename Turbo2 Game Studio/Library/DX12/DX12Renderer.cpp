...
void Application_DX12::DX12Renderer::Resize(float width, float height)
{
	_deviceResources->SetLogicalSize(Size(width, height));
}

void Application_DX12::DX12Renderer::SetDPI(float logicalDPI)
{
	_deviceResources->SetDpi(logicalDPI);
}

void Application_DX12::DX12Renderer::SetDisplayOrientation(Windows::Graphics::Display::DisplayOrientations displayOrientation)
{
	_deviceResources->SetCurrentOrientation(displayOrientation);
}

void Application_DX12::DX12Renderer::ValidateDevice()
{
	_deviceResources->ValidateDevice();
}

bool Application_DX12::DX12Renderer::NeedsReset()
{
	return _deviceResources->IsDeviceRemoved();
}

bool DX12Renderer::LoadSceneResources(std::shared_ptr<ITurboScene> scene)
{
	ReleaseSceneResources();
...
bool DX12Renderer::RenderScene(std::shared_ptr<ITurboScene> scene)
{
	auto commandQueue = _deviceResources->GetCommandQueue();
...
void DX12Renderer::ReleaseSceneResources()
{
...
void Application_DX12::DX12Renderer::CreateCommandList()
{
...
void Application_DX12::DX12Renderer::ResetCommandList()
{
...
void Application_DX12::DX12Renderer::ExecuteCommandList()
{
...
void DX12Renderer::CreateSceneVertexResources(std::shared_ptr<ITurboScene> scene)
{
	if (scene == nullptr)
	{
		return;
...
void DX12Renderer::LoadSceneObjectVertices(std::shared_ptr<ITurboSceneObject> sceneObject)
{
...
void DX12Renderer::LoadVertexData(
...
void DX12Renderer::CreateSceneTextureResources(std::shared_ptr<ITurboScene> scene)
{
	if (scene == nullptr)
	{
		return;
...
void DX12Renderer::LoadSceneObjectTextures(std::shared_ptr<ITurboSceneObject> sceneObject)
{
...
void DX12Renderer::LoadTextureData(
...
void DX12Renderer::CreateCBVSRVDescriptorHeap()
{
...
void DX12Renderer::CreateCBVDescriptors()
{
...
void DX12Renderer::CreateSRVDescriptors()
{
...
void DX12Renderer::CreateSamplerDescriptorHeap()
{
...
void DX12Renderer::CreateSamplerDescriptor()
{
...
void DX12Renderer::UpdateViewMatrix(std::shared_ptr<ITurboScenePlacement> cameraPlacement)
{
...
void DX12Renderer::InitializeRendering()
{
	ResetCommandList();
...
void DX12Renderer::PopulateCommandList(std::shared_ptr<ITurboScene> scene)
{
	if (scene == nullptr)
	{
		return;
...
void DX12Renderer::PopulateCommandList(std::shared_ptr<ITurboSceneObject> sceneObject)
{
	std::shared_ptr<ITurboSceneMesh> mesh = sceneObject->Mesh();
...
void DX12Renderer::FinalizeRendering()
{

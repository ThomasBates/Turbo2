...
class GraphicObjectRGB : public IGraphicObject
{
private:
	Color	_color;
...
class BrushRGB : public IBrush
{
private:
	GraphicObjectRGB _go;
	int		_style;
public:
...
class CanvasRGB : public ICanvas
{
private:
	char*	_data;
	int		_width;
...
public:
	...
	CanvasRGB(int width, int height);
	~CanvasRGB();

	//  Property Accessor Methods
	virtual void*	GetData() { return (void*)_data; }
	virtual void	SetData(void* data) { delete [] _data; _data = (char*)data; }
